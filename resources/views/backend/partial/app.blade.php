...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/backend/') }}/assets/css/core/libs.min.css" />

    <!-- Aos Animation Css -->
    <link rel="stylesheet" href="{{ asset('assets/backend/') }}/assets/vendor/aos/dist/aos.css" />

    <!-- Hope Ui Design System Css -->
    <link rel="stylesheet" href="{{ asset('assets/backend/') }}/assets/css/hope-ui.min.css?v=2.0.0" />

    <!-- Custom Css -->
    <link rel="stylesheet" href="{{ asset('assets/backend/') }}/assets/css/custom.min.css?v=2.0.0" />

    <!-- Dark Css -->
    <link rel="stylesheet" href="{{ asset('assets/backend/') }}/assets/css/dark.min.css" />

    <!-- Customizer Css -->
    <link rel="stylesheet" href="{{ asset('assets/backend/') }}/assets/css/customizer.min.css" />

    <!-- RTL Css -->
    <link rel="stylesheet" href="{{ asset('assets/backend/') }}/assets/css/rtl.min.css" />
...
<body class="  ">
        ...
        <div class="position-relative iq-banner">
                        ...
                        <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                <a href="#" class="search-toggle nav-link" id="dropdownMenuButton2"
                                    ...
                                    <img src="{{ asset('assets/backend/') }}/assets/images/Flag/flag001.png"
                                        ...
                                        <div class="p-0 ">
                                            <ul class="p-0 list-group list-group-flush">
                                                <li class="iq-sub-card list-group-item"><a class="p-0"
                                                        href="#"><img
                                                            src="{{ asset('assets/backend/') }}/assets/images/Flag/flag-03.png"
                                                            alt="img-flaf" class="img-fluid me-2"
                                                            style="width: 15px;height: 15px;min-width: 15px;" />Spanish</a>
                                                </li>
                                                <li class="iq-sub-card list-group-item"><a class="p-0"
                                                        href="#"><img
                                                            src="{{ asset('assets/backend/') }}/assets/images/Flag/flag-04.png"
                                                            alt="img-flaf" class="img-fluid me-2"
                                                            style="width: 15px;height: 15px;min-width: 15px;" />Italian</a>
                                                </li>
                                                <li class="iq-sub-card list-group-item"><a class="p-0"
                                                        href="#"><img
                                                            src="{{ asset('assets/backend/') }}/assets/images/Flag/flag-02.png"
                                                            alt="img-flaf" class="img-fluid me-2"
                                                            style="width: 15px;height: 15px;min-width: 15px;" />French</a>
                                                </li>
                                                <li class="iq-sub-card list-group-item"><a class="p-0"
                                                        href="#"><img
                                                            src="{{ asset('assets/backend/') }}/assets/images/Flag/flag-05.png"
                                                            alt="img-flaf" class="img-fluid me-2"
                                                            style="width: 15px;height: 15px;min-width: 15px;" />German</a>
                                                </li>
                                                <li class="iq-sub-card list-group-item"><a class="p-0"
                                                        href="#"><img
                                                            src="{{ asset('assets/backend/') }}/assets/images/Flag/flag-06.png"
                                                            alt="img-flaf" class="img-fluid me-2"
                                        ...
                                        <div class="p-0 card-body">
                                            <a href="#" class="iq-sub-card">
                                                <div class="d-flex align-items-center">
                                                    <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                        src="{{ asset('assets/backend/') }}/assets/images/shapes/01.png"
                                                        alt="">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="d-flex align-items-center">
                                                    <div class="">
                                                        <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                            src="{{ asset('assets/backend/') }}/assets/images/shapes/02.png"
                                                            alt="">
                                                    </div>
                                                    <div class="ms-3 w-100">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="d-flex align-items-center">
                                                    <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                        src="{{ asset('assets/backend/') }}/assets/images/shapes/03.png"
                                                        alt="">
                                                    <div class="ms-3 w-100">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="d-flex align-items-center">
                                                    <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                        src="{{ asset('assets/backend/') }}/assets/images/shapes/04.png"
                                                        alt="">
                                        ...
                                        <div class="p-0 card-body ">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="d-flex align-items-center">
                                                    <div class="">
                                                        <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                            src="{{ asset('assets/backend/') }}/assets/images/shapes/05.png"
                                                            alt="">
                                                    </div>
                                                    <div class="ms-3">
                            ...
                            <li class="nav-item dropdown">
                                <a class="py-0 nav-link d-flex align-items-center" href="#"
                                    ...
                                    aria-expanded="false">
                                    <img src="{{ asset('assets/backend/') }}/assets/images/avatars/01.png"
                                        alt="User-Profile"
                                        class="theme-color-default-img img-fluid avatar avatar-50 avatar-rounded">
                                    <img src="{{ asset('assets/backend/') }}/assets/images/avatars/avtar_1.png"
                                        alt="User-Profile"
                                        class="theme-color-purple-img img-fluid avatar avatar-50 avatar-rounded">
                                    <img src="{{ asset('assets/backend/') }}/assets/images/avatars/avtar_2.png"
                                        alt="User-Profile"
                                        class="theme-color-blue-img img-fluid avatar avatar-50 avatar-rounded">
                                    <img src="{{ asset('assets/backend/') }}/assets/images/avatars/avtar_4.png"
                                        alt="User-Profile"
                                        class="theme-color-green-img img-fluid avatar avatar-50 avatar-rounded">
                                    <img src="{{ asset('assets/backend/') }}/assets/images/avatars/avtar_5.png"
                                        alt="User-Profile"
                                        class="theme-color-yellow-img img-fluid avatar avatar-50 avatar-rounded">
                                    <img src="{{ asset('assets/backend/') }}/assets/images/avatars/avtar_3.png"
                                        alt="User-Profile"
            ...
            <div class="iq-navbar-header" style="height: 215px;">
                ...
                <div class="iq-header-img">
                    <img src="{{ asset('assets/backend/') }}/assets/images/dashboard/top-header.png" alt="header"
                        class="theme-color-default-img img-fluid w-100 h-100 animated-scaleX">
                    <img src="{{ asset('assets/backend/') }}/assets/images/dashboard/top-header1.png"
                        alt="header" class="theme-color-purple-img img-fluid w-100 h-100 animated-scaleX">
                    <img src="{{ asset('assets/backend/') }}/assets/images/dashboard/top-header2.png"
                        alt="header" class="theme-color-blue-img img-fluid w-100 h-100 animated-scaleX">
                    <img src="{{ asset('assets/backend/') }}/assets/images/dashboard/top-header3.png"
                        alt="header" class="theme-color-green-img img-fluid w-100 h-100 animated-scaleX">
                    <img src="{{ asset('assets/backend/') }}/assets/images/dashboard/top-header4.png"
                        alt="header" class="theme-color-yellow-img img-fluid w-100 h-100 animated-scaleX">
                    <img src="{{ asset('assets/backend/') }}/assets/images/dashboard/top-header5.png"
                ...
                <div class="col-lg-12">
                    ...
                    <div class="d-grid gap-3 grid-cols-2 mb-4">
                        <div class="text-center">
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/dark/01.png"
                                alt="ltr"
                                class="mode dark-img img-fluid btn-border p-0 flex-column active mb-2"
                                data-setting="dir-mode" data-name="dir" data-value="ltr">
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/light/01.png"
                                alt="ltr"
                        ...
                        <div class="text-center">
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/dark/02.png"
                                alt="" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="dir-mode" data-name="dir" data-value="rtl">
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/light/02.png"
                    ...
                    <div class="d-grid gap-3 grid-cols-3 mb-4">
                        <div class="text-center">
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/dark/03.png"
                            ...
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/light/03.png"
                                alt="mini" class="mode light-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-mini">
                            <span class="mt-2">Mini</span>
                        </div>
                        <div class="text-center">
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/dark/04.png"
                            ...
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/light/04.png"
                        ...
                        <div class="text-center">
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/dark/05.png"
                            ...
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/light/05.png"
                    ...
                    <div class="d-grid gap-3 grid-cols-2 mb-4">
                        <div class="text-center">
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/dark/06.png"
                            ...
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/light/06.png"
                                alt="rounded-one-side"
                        ...
                        <div class="text-center">
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/dark/07.png"
                                alt="rounded-all"
                                class="mode dark-img img-fluid btn-border p-0 flex-column active mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded-all">
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/light/07.png"
                                alt="rounded-all"
                                class="mode light-img img-fluid btn-border p-0 flex-column active mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded-all">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/dark/08.png"
                            ...
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/light/09.png"
                                alt="pill-one-side" class="mode light-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-pill">
                            <span class="mt-2">Pill One Side</span>
                        </div>
                        <div class="text-center">
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/dark/09.png"
                            ...
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/light/08.png"
                    ...
                    <div class="d-grid gap-3 grid-cols-2 ">
                        <div class=" text-center">
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/dark/11.png"
                            ...
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/light/10.png"
                        ...
                        <div class="text-center">
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/dark/10.png"
                            ...
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/light/11.png"
                        ...
                        <div class=" text-center">
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/dark/12.png"
                                alt="sticky" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type"
                                data-value="navs-sticky">
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/light/12.png"
                        ...
                        <div class="text-center">
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/dark/13.png"
                                alt="transparent" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type"
                                data-value="navs-transparent">
                            <img src="{{ asset('assets/backend/') }}/assets/images/settings/light/13.png"
    ...
    <script src="{{ asset('assets/backend/') }}/assets/js/core/libs.min.js"></script>

    <!-- External Library Bundle Script -->
    <script src="{{ asset('assets/backend/') }}/assets/js/core/external.min.js"></script>

    <!-- Widgetchart Script -->
    <script src="{{ asset('assets/backend/') }}/assets/js/charts/widgetcharts.js"></script>

    <!-- mapchart Script -->
    <script src="{{ asset('assets/backend/') }}/assets/js/charts/vectore-chart.js"></script>
    <script src="{{ asset('assets/backend/') }}/assets/js/charts/dashboard.js"></script>

    <!-- fslightbox Script -->
    <script src="{{ asset('assets/backend/') }}/assets/js/plugins/fslightbox.js"></script>

    <!-- Settings Script -->
    <script src="{{ asset('assets/backend/') }}/assets/js/plugins/setting.js"></script>

    <!-- Slider-tab Script -->
    <script src="{{ asset('assets/backend/') }}/assets/js/plugins/slider-tabs.js"></script>

    <!-- Form Wizard Script -->
    <script src="{{ asset('assets/backend/') }}/assets/js/plugins/form-wizard.js"></script>

    <!-- AOS Animation Plugin-->
    <script src="{{ asset('assets/backend/') }}/assets/vendor/aos/dist/aos.js"></script>

    <!-- App Script -->
    <script src="{{ asset('assets/backend/') }}/assets/js/hope-ui.js" defer></script>
